                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control py-4  @error('email') is-invalid @enderror" name="email" id="inputEmailAddress" type="email" aria-describedby="emailHelp"  value="{{ old('email') }}" required autocomplete="email" placeholder="Enter email address" />
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputConfirmPassword" type="password" name="password_confirmation" required autocomplete="new-password"placeholder="Confirm password" />
                                            </div>
                                        </div>
                                    </div>
